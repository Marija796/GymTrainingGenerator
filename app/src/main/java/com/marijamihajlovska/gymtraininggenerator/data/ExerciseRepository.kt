...
object ExerciseRepository {
    ...
    val all: List<ExerciseItem> = listOf(
        ...
        ExerciseItem(
            ...
            descriptionMk = "Легнете на рамна клупа со шипката закачена над градите. Фатете малку поширока хватка од ширината на рамената, спуштете ја шипката до средината на градите со контрола, а потоа силно притиснете нагоре."
        ),
        ExerciseItem(
            id = "incline_db_press",
            ...
            descriptionMk = "Наместете ја клупата на 30–45°. Притискајте ги темпарите од нивото на градите нагоре задржувајќи ги лактите на 75°. Стиснете го горниот дел на градите на врвот."
        ),
        ExerciseItem(
            id = "push_ups",
            name = "Push-ups",
            ...
            descriptionMk = "Застанете во висока штица со рацете на ширина на рамена. Спуштете ги градите кон подот задржувајќи ги лактите на 45°. Притиснете се назад до целосно растегнување."
        ),
        ExerciseItem(
            id = "cable_fly",
            name = "Cable Fly",
            ...
            descriptionMk = "Застанете помеѓу кабелите со рачките на висина на градите. Со лесно свиткани лакти, спојте ги рачките во лак пред градите."
        ),
        ExerciseItem(
            id = "dips",
            name = "Dips",
            ...
            descriptionMk = "Фатете ги паралелните шипки и спуштете го телото со свиткување на лактите до 90°. Наведнете се малку напред за да го таргетирате градниот кош. Вратете се на почеток."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Застанете над шипката со стапалата на ширина на колковите. Наведнете се во колковите, фатете ја шипката малку надвор од колената. Притискајте преку петиците, истегнете ги колковите и колената истовремено за да застанете исправно."
        ),
        ExerciseItem(
            id = "pull_ups",
            name = "Pull-ups",
            ...
            descriptionMk = "Висете на шипката со хватка со дланки насочени надвор, малку поширока од рамената. Повлечете ја брадата над шипката движејќи ги лактите кон колковите. Спуштете бавно."
        ),
        ExerciseItem(
            id = "lat_pulldown",
            name = "Lat Pulldown",
            ...
            descriptionMk = "Седнете на машината за lat pulldown. Фатете ја шипката поширока од рамената. Повлечете ја шипката надолу до горниот дел на градите, наведнувајќи се малку назад и стегнувајќи ги лопатките."
        ),
        ExerciseItem(
            id = "barbell_rows",
            name = "Barbell Rows",
            ...
            descriptionMk = "Наведнете се во колковите додека торзото е речиси паралелно со подот. Повлечете ја шипката до долниот дел на градите, водејќи ги лактите. Задржете го грбот рамен во текот на вежбата."
        ),
        ExerciseItem(
            id = "cable_rows",
            name = "Cable Rows",
            ...
            descriptionMk = "Седнете на машината за кабелски редови. Повлечете ја рачката до долниот дел на стомакот седејќи исправно. Стегнете ги лопатките заедно при максималната контракција."
        ),
        ExerciseItem(
            id = "face_pulls",
            name = "Face Pulls",
            ...
            descriptionMk = "Прикачете јаже на висина на лицето. Повлечете го јажето кон лицето со лактите високо и широко, завршувајќи со рацете покрај ушите. Одлично за здравјето на рамената."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Застанете со шипката на горниот дел на градите, хватка малку надвор од рамената. Притиснете нагоре додека рацете се целосно испружени. Спуштете со контрола."
        ),
        ExerciseItem(
            id = "lateral_raises",
            name = "Lateral Raises",
            ...
            descriptionMk = "Држете темпари на страна со лесно свиткани лакти. Подигнете ги рацете настрана до висина паралелна со подот. Контролирајте го спуштањето."
        ),
        ExerciseItem(
            id = "front_raises",
            name = "Front Raises",
            ...
            descriptionMk = "Држете темпари пред бутовите. Подигнете ги рацете напред до висина на рамената, задржувајќи лесно свиткани лакти. Спуштете со контрола."
        ),
        ExerciseItem(
            id = "rear_delt_fly",
            name = "Rear Delt Fly",
            ...
            descriptionMk = "Наведнете се напред во колковите. Со висечки темпари, подигнете ги рацете настрана стегнувајќи ги задните делтоиди. Задржете лесно свиткани лакти."
        ),
        ExerciseItem(
            id = "arnold_press",
            name = "Arnold Press",
            ...
            descriptionMk = "Започнете со темпарите на нивото на брадата, дланките свртени кон вас. Додека притискате нагоре, ротирајте ги дланките напред. Вратете во спротивна насока при спуштањето."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Држете темпари со дланките свртени напред. Задржете ги лактите прилепени до телото. Свиткајте ги тежините до висина на рамената стегнувајќи ги бицепсите. Спуштете бавно."
        ),
        ExerciseItem(
            id = "hammer_curls",
            name = "Hammer Curls",
            ...
            descriptionMk = "Држете темпари со дланките свртени едни кон други (неутрална хватка). Свиткајте до висина на рамената задржувајќи ги зглобовите неутрални. Одлично за дебелина на целата рака."
        ),
        ExerciseItem(
            ...
            descriptionMk = "Седнете на клупа и потпрете го лактот на внатрешниот дел на бутот. Свиткајте го темпарот до рамото фокусирајќи се на врвната контракција."
        ),
        ExerciseItem(
            id = "tricep_dips",
            name = "Tricep Dips",
            ...
            descriptionMk = "Поставете ги рацете на клупа зад вас, нозете испружени. Спуштете го телото свиткувајќи ги лактите до 90°, а потоа вратете се. Задржете го торзото исправно."
        ),
        ExerciseItem(
            id = "skull_crushers",
            name = "Skull Crushers",
            ...
            descriptionMk = "Легнете на клупа со шипката испружена над градите. Задржувајќи ги горните раце вертикални, свиткајте ги лактите за да ја спуштите шипката кон челото. Испружете назад."
        ),
        ExerciseItem(
            id = "tricep_pushdown",
            ...
            descriptionMk = "Застанете на кабелската машина со шипката на висина на лицето. Задржете ги лактите на страна и притиснете ја шипката надолу до нивото на колковите. Стегнете ги трицепсите при целосно испружување."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Шипката на горните трапези, стапалата на ширина на рамената. Стегнете ја јадрото, наведнете се во колковите и колената за да клечнете додека бутовите се паралелни. Притиснете преку петиците за да застанете."
        ),
        ExerciseItem(
            ...
            descriptionMk = "Држете ја шипката на висина на колковите. Наведнете се напред во колковите со лесно свиткани колена, спуштајќи ја шипката по нозете додека почувствувате истегнување во хамстрингот. Поместете ги колковите напред за да застанете."
        ),
        ExerciseItem(
            id = "leg_press",
            name = "Leg Press",
            ...
            descriptionMk = "Седнете во машината со стапалата на ширина на рамената на платформата. Спуштете ја платформата додека колената не достигнат 90°. Притиснете преку петиците до целосно испружување без да ги заклучувате колената."
        ),
        ExerciseItem(
            id = "lunges",
            name = "Lunges",
            ...
            descriptionMk = "Застанете исправно, чекорете напред со едната нога и спуштете го задното колено кон подот. Притиснете преку предната пета за да се вратите. Менувајте ноге."
        ),
        ExerciseItem(
            id = "calf_raises",
            name = "Calf Raises",
            ...
            descriptionMk = "Застанете со топките на стапалата на возвишена површина. Подигнете се колку е можно повисоко на прсти. Спуштете бавно за целосно истегнување на дното."
        ),
        ExerciseItem(
            id = "glute_bridges",
            name = "Glute Bridges",
            ...
            descriptionMk = "Легнете на грб со свиткани колена и рамни стапала. Поместете ги колковите нагоре стегнувајќи ги глутеусите, формирајќи права линија од колената до рамената. Задржете 2 секунди на врвот."
        ),
        ExerciseItem(
            id = "leg_curl",
            name = "Leg Curl",
            ...
            descriptionMk = "Легнете со лице надолу на машината со подлогите на задниот дел на глужбовите. Свиткајте ги петиците кон глутеусите стегнувајќи ги хамстрингите при врвот. Спуштете со контрола."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Задржете позиција на штица (или на подлактиците). Задржете го телото во права линија од главата до петиците. Дишете рамномерно и стегнете ја јадрото."
        ),
        ExerciseItem(
            id = "crunches",
            name = "Crunches",
            ...
            descriptionMk = "Легнете на грб со свиткани колена. Поставете ги рацете зад главата. Свиткајте ги рамената од подот контрахирајќи ги стомачните мускули. Не влечете ја вратот."
        ),
        ExerciseItem(
            id = "russian_twists",
            name = "Russian Twists",
            ...
            descriptionMk = "Седнете со свиткани колена, наведнете се малку назад. Ротирајте го торзото лево-десно, допирајќи го подот покрај секој колк. Додајте тежина за поголема тешкотија."
        ),
        ExerciseItem(
            id = "leg_raises",
            name = "Leg Raises",
            ...
            descriptionMk = "Легнете рамно на грб со испружени нозе. Задржете го долниот дел на грбот притиснат на подот. Подигнете ги нозете до 90°, а потоа бавно спуштете без да го допирате подот."
        ),
        ExerciseItem(
            ...
            descriptionMk = "Започнете во висока штица. Наизменично возете ги колената кон градите колку е можно побрзо задржувајќи ги колковите рамни и јадрото стегнато."
        ),
        ExerciseItem(
            id = "ab_rollout",
            name = "Ab Rollout",
            ...
            descriptionMk = "Клечете на под држејќи го тркалото за стомак. Котрлајте напред испружувајќи го телото, задржувајќи ги колковите да не провиснат. Користете ја јадрото за да се вратите на почетната позиција."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Застанете со соединети стапала, рацете покрај телото. Скокнете со стапалата настрана додека ги подигате рацете над главата. Вратете се на почетокот и повторете. Одржувајте рамномерен ритам."
        ),
        ExerciseItem(
            id = "burpees",
            name = "Burpees",
            ...
            descriptionMk = "Спуштете се во позиција за склекови, направете еден склек, скокнете со стапалата кон рацете, а потоа експлодирајте нагоре со рацете над главата. Едно од најефикасните движења за согорување маснотии."
        ),
        ExerciseItem(
            id = "high_knees",
            name = "High Knees",
            ...
            descriptionMk = "Трчајте на место возејќи ги колената до висина на колковите со секој чекор. Движете ги рацете и одржувајте исправна постура. Одржувајте брзо темпо."
        ),
        ExerciseItem(
            id = "box_jumps",
            name = "Box Jumps",
            ...
            descriptionMk = "Застанете пред стабилна кутија. Наведнете се малку и скокнете на кутијата со двете стапала. Чекорете назад и поставете се. Фокусирајте се на меко слетување."
        ),
        ExerciseItem(
            id = "jump_rope",
            name = "Jump Rope",
            ...
            descriptionMk = "Држете ги рачките на јажето на висина на колковите. Скокнете со двете стапала над јажето додека поминува под нив. Бидете лесни на стапалата и одржувајте рамномерно темпо."
        ),
        ...
        ExerciseItem(
            ...
            descriptionMk = "Наведнете се во колковите и нишајте го кетлбелот помеѓу нозете. Енергично поместете ги колковите напред за да го нишнете до висина на рамената. Моќта доаѓа од колковите, не од рацете."
        ),
        ExerciseItem(
            id = "clean_and_press",
            ...
            descriptionMk = "Повлечете ја шипката од подот енергично до висина на рамената (чист), а потоа притиснете нагоре. Комплетно движење на сила кое таргетира секоја главна мускулна група."
        ),
        ExerciseItem(
            id = "thruster",
            name = "Thruster",
        ...
        videoUrl = ytEmbed("L219ltL15zk"),
            descriptionMk = "Држете ја шипката на градите. Клечнете до паралелно, а потоа искористете го замавот на исправувањето за да ја поместите шипката над главата во едно течно движење. Основно CrossFit движење."
        )
    )
